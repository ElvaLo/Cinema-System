...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<link href="/library/skin/neo-owl/tool.css" type="text/css" rel="stylesheet" media="all" />
	...
	<body onload="if ((document.getElementById('pw').passwordfocus != true)) document.getElementById('eid').focus() ;parent.updCourier(doubleDeep, ignoreCourier);">
		...
		<tr>
			<td class="logo"></td>
			<td class="form">
				<form method="post" action="https://owl.uwo.ca/access/login" enctype="application/x-www-form-urlencoded">
					...
					<tr>
						...
						<script type="text/javascript" src="/library/js/caps-lock-checker.js"></script>
										...
										<tr>
						<td colspan="2"><a href="https://owl.uwo.ca/portal/site/!gateway/page/0843e7f9-5eb3-4eb1-82c6-8e7720f168e9">Forgotten your password?</a></td>
					</tr>
										</table>
				</form>
			</td>
